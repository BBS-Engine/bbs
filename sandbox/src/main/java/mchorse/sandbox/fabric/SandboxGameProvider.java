...
public class SandboxGameProvider implements GameProvider
{
    private Arguments arguments;
    private Path gameDirectory;
    private GameTransformer transformer = new SandboxGameTransformer();
    private List<Path> jars = new ArrayList<Path>();
    private Set<String> jarFiles;

    public SandboxGameProvider()
    {
    ...
    {
        BuiltinMod mod = new BuiltinMod(this.jars, new BuiltinModMetadata.Builder("bbs", Sandbox.VERSION).build());
    ...
    {
        return "mchorse.sandbox.Sandbox";
    }
