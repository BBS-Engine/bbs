package mchorse.sandbox.ui.welcome;
...
{
    private static final Link KEYBOARD = Sandbox.link("textures/keyboard.png");
    ...
    public UIWelcomeMenu(IBridge bridge)
    {
        ...
        this.featureList.add(new Label<LinkDescription>(
            ...
            new LinkDescription(Sandbox.link("textures/features/world_editor.png"), UIKeysApp.WELCOME_FEATURES_WORLD_EDITOR_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_TILE_SETS,
            new LinkDescription(Sandbox.link("textures/features/tile_sets.png"), UIKeysApp.WELCOME_FEATURES_TILE_SETS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_PARTICLES,
            new LinkDescription(Sandbox.link("textures/features/particles.png"), UIKeysApp.WELCOME_FEATURES_PARTICLES_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_CAMERA,
            new LinkDescription(Sandbox.link("textures/features/camera.png"), UIKeysApp.WELCOME_FEATURES_CAMERA_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_BLOCKBENCH,
            new LinkDescription(Sandbox.link("textures/features/blockbench.png"), UIKeysApp.WELCOME_FEATURES_BLOCKBENCH_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_TRIGGERS,
            new LinkDescription(Sandbox.link("textures/features/triggers.png"), UIKeysApp.WELCOME_FEATURES_TRIGGERS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_SCRIPTS,
            new LinkDescription(Sandbox.link("textures/features/scripts.png"), UIKeysApp.WELCOME_FEATURES_SCRIPTS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_DIALOGUES,
            new LinkDescription(Sandbox.link("textures/features/dialogues.png"), UIKeysApp.WELCOME_FEATURES_DIALOGUES_DESCRIPTION)
        ));
        this.featureList.background(Colors.A25).sort();
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_MORE,
            new LinkDescription(Sandbox.link("textures/features/more.png"), UIKeysApp.WELCOME_FEATURES_MORE_DESCRIPTION)
        ));
    ...
    private void next(UIIcon b)
    {
        ...
        {
            SandboxSettings.welcome.set(true);
    ...
    protected void closeMenu()
    {
        if (this.page == LAST)
        {
            SandboxEngine engine = (SandboxEngine) this.bridge.getEngine();
