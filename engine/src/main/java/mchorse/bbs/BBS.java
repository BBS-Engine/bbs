...
public class BBS
{
    ...
    public static void registerFactories()
    {
        ...
        factoryClips = new MapFactory<Clip, ClipFactoryData>()
            .register(Link.bbs("idle"), IdleClip.class, new ClipFactoryData(0x159e64, UIIdleClip.class)
            ...
            .register(Link.bbs("dolly"), DollyClip.class, new ClipFactoryData(0xffa500, UIDollyClip.class)
            ...
            .register(Link.bbs("circular"), CircularClip.class, new ClipFactoryData(0x4ba03e, UICircularClip.class)
                .withConverter(Link.bbs("idle"), IdleConverter.CONVERTER))
            .register(Link.bbs("path"), PathClip.class, new ClipFactoryData(0x6820ad, UIPathClip.class)
                .withConverter(Link.bbs("idle"), IdleConverter.CONVERTER))
            .register(Link.bbs("keyframe"), KeyframeClip.class, new ClipFactoryData(0xde2e9f, UIKeyframeClip.class)
                .withConverter(Link.bbs("idle"), IdleConverter.CONVERTER)
                .withConverter(Link.bbs("keyframe"), new PathToKeyframeConverter()))

            .register(Link.bbs("translate"), TranslateClip.class, new ClipFactoryData(0x4ba03e, UITranslateClip.class))
            .register(Link.bbs("angle"), AngleClip.class, new ClipFactoryData(0xd77a0a, UIAngleClip.class))
            .register(Link.bbs("drag"), DragClip.class, new ClipFactoryData(0x4baff7, UIDragClip.class))
            .register(Link.bbs("shake"), ShakeClip.class, new ClipFactoryData(0x159e64, UIShakeClip.class))
            .register(Link.bbs("math"), MathClip.class, new ClipFactoryData(0x6820ad, UIMathClip.class))
            .register(Link.bbs("look"), LookClip.class, new ClipFactoryData(0x197fff, UILookClip.class))
            .register(Link.bbs("orbit"), OrbitClip.class, new ClipFactoryData(0xd82253, UIOrbitClip.class))
            .register(Link.bbs("remapper"), RemapperClip.class, new ClipFactoryData(0x222222, UIRemapperClip.class))

            .register(Link.bbs("scene"), SceneClip.class, new ClipFactoryData(0xff1493, UISceneClip.class))
            .register(Link.bbs("audio"), AudioClip.class, new ClipFactoryData(0xffffc825, UIAudioClip.class))
            .register(Link.bbs("animation"), AnimationClip.class, new ClipFactoryData(0xeeeeee, UIAnimationClip.class));
