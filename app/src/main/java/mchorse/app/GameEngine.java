...
import mchorse.app.bridge.BridgeAnimations;
import mchorse.app.bridge.BridgeCamera;
import mchorse.app.bridge.BridgeHUD;
import mchorse.app.bridge.BridgeMenu;
import mchorse.app.bridge.BridgePlayer;
import mchorse.app.bridge.BridgeRender;
import mchorse.app.bridge.BridgeVideoRecorder;
import mchorse.app.bridge.BridgeWorld;
import mchorse.app.settings.AppSettings;
import mchorse.app.ui.KeysApp;
import mchorse.app.ui.UIKeysApp;
import mchorse.app.ui.UIScreen;
import mchorse.app.ui.l10n.UILanguageEditorOverlayPanel;
import mchorse.app.ui.utility.UIUtilityMenu;
import mchorse.app.ui.utility.UIUtilityOverlayPanel;
import mchorse.app.utils.AssetFileTree;
...
public class GameEngine extends Engine implements IBridge, IFileDropListener
{
    /* Game */
    ...
    {
        event.register("app", AppSettings::register);
    ...
    public void registerL10n(RegisterL10nEvent event)
    {
        ...
        event.l10n.registerOne((lang) -> Link.create("app:strings/" + lang + ".json"));
    }
    ...
    {
        BBS.getProvider().register(new InternalAssetsSourcePack("app", GameEngine.class));
    ...
    public void init() throws Exception
    {
        ...
        Game.PROFILER.endBegin("window_icon");
        this.updateWindowIcon();

        Game.PROFILER.endBegin("init_bbs");
        BBS.initialize();
        Game.PROFILER.endBegin("init_bbs_data");
        BBSData.load(BBS.getDataFolder(), this);

        Game.PROFILER.endBegin("init_renderer");
        this.renderer.init();
        this.screen.init();
        ...
        Game.PROFILER.endBegin("init_js");
        this.forceLoadJS();
        Game.PROFILER.endBegin("init_callbacks");
    ...
    {
        AppSettings.renderFrameRate.callback((v) -> this.frameRate = ((ValueInt) v).get());
        AppSettings.renderVsync.callback((v) -> Window.setVSync(((ValueBoolean) v).get()));
        AppSettings.renderQuality.callback((v) -> this.resize(Window.width, Window.height));
