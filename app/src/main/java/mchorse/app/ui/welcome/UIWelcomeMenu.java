...
{
    private static final Link KEYBOARD = Link.create("app:textures/keyboard.png");
    ...
    public UIWelcomeMenu(IBridge bridge)
    {
        ...
        this.featureList.add(new Label<LinkDescription>(
            ...
            new LinkDescription(Link.create("app:textures/features/world_editor.png"), UIKeysApp.WELCOME_FEATURES_WORLD_EDITOR_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_TILE_SETS,
            new LinkDescription(Link.create("app:textures/features/tile_sets.png"), UIKeysApp.WELCOME_FEATURES_TILE_SETS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_PARTICLES,
            new LinkDescription(Link.create("app:textures/features/particles.png"), UIKeysApp.WELCOME_FEATURES_PARTICLES_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_CAMERA,
            new LinkDescription(Link.create("app:textures/features/camera.png"), UIKeysApp.WELCOME_FEATURES_CAMERA_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_BLOCKBENCH,
            new LinkDescription(Link.create("app:textures/features/blockbench.png"), UIKeysApp.WELCOME_FEATURES_BLOCKBENCH_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_TRIGGERS,
            new LinkDescription(Link.create("app:textures/features/triggers.png"), UIKeysApp.WELCOME_FEATURES_TRIGGERS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_SCRIPTS,
            new LinkDescription(Link.create("app:textures/features/scripts.png"), UIKeysApp.WELCOME_FEATURES_SCRIPTS_DESCRIPTION)
        ));
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_DIALOGUES,
            new LinkDescription(Link.create("app:textures/features/dialogues.png"), UIKeysApp.WELCOME_FEATURES_DIALOGUES_DESCRIPTION)
        ));
        this.featureList.background(Colors.A25).sort();
        this.featureList.add(new Label<LinkDescription>(
            UIKeysApp.WELCOME_FEATURES_MORE,
            new LinkDescription(Link.create("app:textures/features/more.png"), UIKeysApp.WELCOME_FEATURES_MORE_DESCRIPTION)
        ));
        ...
        this.patrons.text(UIKeysApp.WELCOME_PATRONS.format(IKey.str("Aesthics\nEgor\nFavreMySabre\nLaff\nTerbin\nYcar")));
    ...
    {
        return Link.create("app:welcome");
    }
    ...
    protected void closeMenu()
    {
        if (this.page == LAST)
        {
            GameEngine engine = (GameEngine) this.bridge.getEngine();
