...
public class StudioGameProvider implements GameProvider
{
    private Arguments arguments;
    private Path gameDirectory;
    private GameTransformer transformer = new StudioGameTransformer();
    private List<Path> jars = new ArrayList<Path>();
    private Set<String> jarFiles;

    public StudioGameProvider()
    {
    ...
    {
        BuiltinMod mod = new BuiltinMod(this.jars, new BuiltinModMetadata.Builder("bbs", Studio.VERSION).build());
